...
<!-- saved from url=(0088)https://login.vancl.com/login/login.aspx?http%3A%2F%2Fwww.vancl.com%2F%23ref%3Dhead-tcdl -->
<html xmlns="http://www.w3.org/1999/xhtml"><head id="Head1"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>
	凡客诚品 - 会员登录
</title><link href="/ho/login/login.css" rel="stylesheet" type="text/css"><link href="/ho/login/footer.css" rel="stylesheet" type="text/css"><link href="/ho/login/css.ashx" rel="stylesheet" type="text/css"><link rel="shortcut icon" href="https://ssl.vanclimg.com/common/favicon/favicon.ico" type="image/x-icon">
    <script type="text/javascript" language="javascript" src="/ho/login/js.ashx"></script>
    
    <script type="text/javascript" language="javascript" src="/ho/login/script.ashx"></script>
    
    <script type="text/javascript" language="javascript" src="/ho/login/login.js"></script>
    ...
    <div class="wrapper">
        ...
        <div class="login">
                ...
                ****************************************************
                ...
                <div class="user_infor" style="display: none">
                    ...
                    <div id="_quickcode" class="newtxt" style="border: 0 none;">
                       ...
                       <!--  <a style="cursor: pointer; float: right; line-height: 18px;"  onclick='this.previousSibling.src=this.previousSibling.src+"?id="+Math.random()'>
                            看不清?换一张</a> -->
                        <button style="cursor: pointer; float: right; line-height: 18px; border:0px; background:white" id="kan">看不清?换一张</button>
                    </div>
                ...
                <div class="glup">
                    ...
                    <span class="blank10"></span>
                    <p class="qkimg">
                        <a href="https://login.vancl.com/login/wxlogin.aspx?http%3A%2F%2Fwww.vancl.com%2F%23ref%3Dhead-tcdl" id="a_wxlogin" class="weixin">
         ...
         <!--    <div class="user_infor" style="display: none">
                ...
                <p>
                    <label>
                        用户名：</label><input id="PartnerUserName" name="PartnerUserName" type="text" value="327bdd7eef0f4e0db06030ce7fde3a72" class="inputtextcolor">
                </p>
                ...
                <p id="pVjiaValidate" style="display:none">
                    ...
                    <img id="img_vjiaValidate" oldsrc="/code" src="/code" style="vertical-align: middle; width: 145px; height: 53px; cursor: pointer;"><a style="cursor: pointer;
                ...
                <div class="bt">
                    <a id="vjiaLogin" class="log" href="https://login.vancl.com/login/login.aspx?http%3A%2F%2Fwww.vancl.com%2F%23ref%3Dhead-tcdl#">登 录</a> <a class="forget" href="http://www.vjia.com/Login/GetPwdStep1.aspx">
                        忘记密码啦？</a>
                </div>
                <div class="tishi">
        ...
        <div class="advert">
            <img src="/ho/login/login120412_newlogo.jpg" id="_advertImage" style="width: 465px; display: none">
            <img src="/ho/login/login120412_newlogo(1).jpg" style="width: 465px">
        </div>
        <!--shows-->
...
<div id="bottom" align="center">
    ...
    <script src="/ho/login/quicklogin.js"></script>
