...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
    	<form action="/admin/picdetail/update" class="mws-form" method="post" enctype="multipart/form-data">
          <input type="hidden" name="id" value='{{$vo['id']}}'>
            ...
            <div class="mws-form-row">
                <label class="mws-form-label">商品详图</label>
                <div class="mws-form-item" width='500'>
                   {!!$vo['picname']!!}
                </div>
            </div>
            <div class="mws-form-row">
                <label class="mws-form-label">修改商品详图</label>
                 <div class="mws-form-item">
                    <script id="editor" type="text/plain" style="width:auto;height:300px;" name="picname">
                    </script>
                </div>
            </div>
