    ...
    <div class="mws-panel-body no-padding">
    	<form action="/admin/goods/update" class="mws-form" method="post" enctype="multipart/form-data">
          <input type="hidden" name="id" value='{{$vo['id']}}'>
            ...
            <div class="mws-form-row">
                <label class="mws-form-label">修改商品主图</label>
                <div class="mws-form-item">
                    <input type="file" class="small" name="picname" value='{{$vo['picname']}}'>
                </div>
            </div>
            <div class="mws-form-row">
                <label class="mws-form-label">商品主图</label>
                <div class="mws-form-item">
                   <img src='{{$vo['picname']}}' alt="" width='100'>
                </div>
            </div>
            <div class="mws-form-row">
            ...
            <div class="mws-form-row">
                <label class="mws-form-label">修改商品描述</label>
                 <div class="mws-form-item">
                    <script id="editor" type="text/plain" style="width:auto;height:300px;" name="descr">
                    </script>
                </div>
            </div>
            <div class="mws-form-row">
