...
<!-- saved from url=(0066)http://my.vancl.com/UserPoints/Index#ref=my-left-left-huiyuanscore -->
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <head id="Head1">
    ...
    <title>我的积分</title>
    <script src="./integral_files/push.js.下载"></script>
    <script type="text/javascript" src="./integral_files/js.ashx"></script>
    <link href="./integral_files/css.ashx" rel="stylesheet" type="text/css">
    <link rel="shortcut icon" href="http://i.vanclimg.com/common/favicon/favicon.ico" type="image/x-icon">
    <link type="text/css" rel="stylesheet" href="./integral_files/css(1).ashx">
    <script type="text/javascript" src="./integral_files/js(1).ashx"></script>
  ...
  <body id="body" class="cols_manage">
    ...
    <div class="wrapper">
      ...
      <div id="side-nav">
        ...
        <ul class="">
          <li>
            <h3>订单中心</h3></li>
          <li class="">
            <a href="http://my.vancl.com/Order/" class="track" name="my-left-left-Order" itemurl="http://my.vancl.com/Order/" url="http://my.vancl.com/UserPoints/Index">·我的订单</a></li>
          <li class="">
            <a href="http://my.vancl.com/Order?type=dingzhi" class="track" name="my-left-left-Order" itemurl="http://my.vancl.com/Order/?type=dingzhi" url="http://my.vancl.com/UserPoints/Index">·我的定制订单</a></li>
          <li class="">
            <a href="http://my.vancl.com/GiftCard" class="track" name="my-left-left-card" itemurl="http://my.vancl.com/GiftCard" url="http://my.vancl.com/UserPoints/Index">·我的礼品卡</a></li>
          <li class="no_bg">
            <a href="http://my.vancl.com/UserPoints/Index" class="track selected" name="my-left-left-huiyuanscore" itemurl="http://my.vancl.com/UserPoints/Index" url="http://my.vancl.com/UserPoints/Index">·我的积分</a></li>
        </ul>
        <ul class="">
          <li>
            <h3>客户服务</h3></li>
          <li class="">
            <a href="http://returns.vancl.com/" class="track" name="my-left-left-returnorder" itemurl="http://returns.vancl.com/" url="http://my.vancl.com/UserPoints/Index">·退换货办理</a></li>
          <li class="">
            <a href="http://my.vancl.com/comment/" class="track" name="my-left-left-productcomment" itemurl="http://my.vancl.com/comment/" url="http://my.vancl.com/UserPoints/Index">·我要评价</a></li>
          <li class="">
            <a href="http://my.vancl.com/question" class="track" name="my-left-left-productquestion" itemurl="http://my.vancl.com/question" url="http://my.vancl.com/UserPoints/Index">·商品提问</a></li>
        </ul>
        <ul class="service-rate">
          <li>
            <h3>账户管理</h3></li>
          <li class="">
            <a href="http://my.vancl.com/user/account" class="track" name="my-left-left-account" itemurl="http://my.vancl.com/user/account" url="http://my.vancl.com/UserPoints/Index">·账户余额</a></li>
          <li class="">
            <a href="http://my.vancl.com/DeliveryAddress/Index" class="track" name="my-left-left-modifyDeliveryInfo" itemurl="http://my.vancl.com/DeliveryAddress/Index" url="http://my.vancl.com/UserPoints/Index">·收货地址</a></li>
          <li class="">
            <a href="http://my.vancl.com/SafeCenter" class="track" name="my-left-left-modifypassword" itemurl="http://my.vancl.com/SafeCenter" url="http://my.vancl.com/UserPoints/Index">·账户安全</a></li>
          <li class="">
            <a href="http://my.vancl.com/User/UserInfo" class="track" name="my-left-left-personinfo" itemurl="http://my.vancl.com/User/UserInfo" url="http://my.vancl.com/UserPoints/Index">·我的资料</a></li>
          <li class="no_bg">
            <a href="http://my.vancl.com/federatedlogin" class="track" name="my-left-left-assoaccount" itemurl="http://my.vancl.com/federatedlogin" url="http://my.vancl.com/UserPoints/Index">·我的关联账户</a></li>
        </ul>
      </div>
      <link type="text/css" rel="stylesheet" href="./integral_files/css(2).ashx">
      <script type="text/javascript" src="./integral_files/js(2).ashx"></script>
      ...
      <div id="con_one_2" style="display: none;">
        <div id="convertingPoint">
          <link href="./integral_files/tip.css" rel="stylesheet" type="text/css">
          <script type="text/javascript" src="./integral_files/js(3).ashx"></script>
          <div id="main" style="margin-top: 0;">
            <div id="orderform" class="mngbox">
              <div class="main">
                <h3>
          ...
          <script type="text/javascript">var points = 0;
            function initTab() {
              var txtPoints = $("#txtPoints");
              if (txtPoints) {
                if (points == 0) txtPoints.show();
                else txtPoints.hide();
              }
            }
            $(function() {
              $("form").validate({
                ...
                messages: {
                  "point": {
                    required: "<em></em><p>请输入积分值&nbsp;</p>",
                    digits: "<em></em><p>请输入整数数字&nbsp;</p>",
                    range: "<em></em><p>积分值必须在 {0} 到 {1} 之间&nbsp;</p>"
                  }
                }
              });
            });
            function OnSuccess(result) {
              $("#tip").html("<div class=\"soucTips\"><em></em><p>" + result + "&nbsp;</p></div>").show();
            }</script>
        </div>
      </div>
      <script language="javascript" type="text/javascript">$(document).ready(function() {
        ...
        $(function() {
          $("#UserMap").html("<a href='/UserPoints/Index'> 我的积分</a>")
        });</script>
      ...
      <div class="vanclFoot" style="margin-top:0px;">
        <div class="vanclCustomer publicfooterclear">
          <ul>
            <li>
              <a href="http://help.vancl.com/Home/contact" rel="nofollow" target="_blank">
                <p class="onlineCustomer">
                  <img src="./integral_files/onlinecustomer.png" style="width:auto;height:auto;"></p>
                <p class="onlineTime">7X9小时在线客服</p></a>
            </li>
            <li>
              <a href="http://help.vancl.com/Category/43-1.html" rel="nofollow" target="_blank">
                <p class="seven">
                  <img src="./integral_files/seven.png" style="width:auto;height:auto;"></p>
                <p>7天内退换货</p>
                <p>购物满199元免运费</p>
              </a>
            </li>
            <li class="twocode">
              <p>
                <img src="./integral_files/2014_8_29_16_39_33_7709.jpg" style="width: 104px; height: 104px;"></p>
              <p>扫描下载
                <em>凡客</em>客户端</p></li>
          </ul>
        </div>
      ...
      <div id="footerArea" class="">
        ...
        <div class="subFooter">
          ...
          <a href="http://trust.cctvmall.cn/reg/templates/brandtem1010.html" style="display: inline-block;" target="_blank">
            <img style="width: 120px; height: 39px;" src="./integral_files/kexin_brand_for_others.png"></a>
    ...
    <div id="WeixinBox" style="position: fixed; bottom: 0px; z-index: 1000; width: 146px;">
      <img src="./integral_files/tc.png" alt="关闭" title="关闭" style="float:right;cursor:pointer;" onclick="closeWeixin();">
      <span class="blank0"></span>
      <img src="./integral_files/vanclqrcode2.jpg" alt="凡客二维码" title="凡客二维码" style="width:144px;border:1px solid #EFEFEF;"></div>
    <script type="text/javascript" src="./integral_files/js(4).ashx"></script>
    <div id="imdiv" style="width:112px; height:25px; padding-top:3px;float:right; background:url(http://i.vanclimg.com/others/2011/11/9/bg.gif) center no-repeat; position:fixed;_position:absolute;_bottom:auto; right:0; bottom:0;_top:expression(eval(document.documentElement.scrollTop+document.documentElement.clientHeight-this.offsetHeight-(parseInt(this.currentStyle.marginTop,10)||0)-(parseInt(this.currentStyle.marginBottom,10)||0)))">
      <img hspace="6" src="./integral_files/icon.gif" align="absmiddle">
      <a style="padding-right:8px;" href="http://imweb.vancl.com/" id="impage" target="_blank">在线客服</a>
      <a href="http://my.vancl.com/UserPoints/Index#">
        <img src="./integral_files/top.gif" hspace="3" align="absmiddle"></a>
    </div>
  </body>
