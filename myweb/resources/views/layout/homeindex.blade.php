                    ...
                    <div class="headerTop">
						...
						@if(session('home'))
                            <div id="welcome" class="top loginArea">您好,
                                <a href="/home/center/index" class="top track" style="color: rgb(51, 51, 51);">{{session('home')[0]['username']}}</a>
 ...
 <!--顶部通栏广告位-->
            <div id="logoArea" class="vanclLogoSearch">
                <div class="vanclSearch fr">
                    <div class="searchTab">
                        <div class="search fl">
                            <input type="text" class="searchText ac_input textBox Enter fl" name="k" id="skey" value="搜“羽绒服”，体验与众不同" defaultkey="羽绒服" autocomplete="off">
